...
import (
	...
	"github.com/rock-go/rock-chameleon-go/mysql/internal/regex"
...
var (
	...
	ErrUnsupportedInOperand = errors.NewKind("right operand in IN operation must be tuple, but is %TypeOf")
